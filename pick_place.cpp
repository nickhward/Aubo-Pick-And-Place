...
void pick(moveit::planning_interface::MoveGroupInterface& move_group)
{
  ...
  tf2::Quaternion orientation;
  orientation.setRPY(-3.102, -0.030, 1.705);
  
  grasps[0].grasp_pose.pose.orientation = tf2::toMsg(orientation);
  grasps[0].grasp_pose.pose.position.x = -0.796;
  grasps[0].grasp_pose.pose.position.y = -0.109;
  grasps[0].grasp_pose.pose.position.z = 0.154;
